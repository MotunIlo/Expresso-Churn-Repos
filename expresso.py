...
st.markdown("<h1 style = 'color: #0C2D57; text-align: center; font-family: geneva'>EXPRESSO CHURN PREDICTOR</h1>", unsafe_allow_html = True)
st.markdown("<h4 style = 'margin: -30px; color: #F11A7B; text-align: center; font-family: cursive '>Ilo Motunrayo </h4>", unsafe_allow_html = True)
st.markdown("<br>", unsafe_allow_html= True)

st.image('pngwing.com (1).png', use_column_width= True, )
